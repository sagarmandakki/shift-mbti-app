...
UPDATE `questions` SET `dimension` = 'EI', `direction` = '1' WHERE (`id` = '1');
UPDATE `questions` SET `dimension` = 'SN', `direction` = '-1' WHERE (`id` = '2');
UPDATE `questions` SET `dimension` = 'TF', `direction` = '1' WHERE (`id` = '3');
UPDATE `questions` SET `id` = '4', `dimension` = 'EI', `direction` = '-1' WHERE (`id` = '4');
...
UPDATE `questions` SET `dimension` = 'EI', `direction` = '-1' WHERE (`id` = '9');
